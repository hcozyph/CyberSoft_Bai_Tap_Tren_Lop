...
//     let nhanVien['ma']: getEle('maNhanVien').value;
//     let tenNhanVien = getEle('tenNhanVien').value;
//     let luongCoBan = getEle('luongCoBan').value;
//     let soGioLam = getEle('soGioLam').value;

//     // let htmlString = '';
//     getEle('ketQuaHienThi').innerHTML = `
...
document.querySelector('#frmNhanVien').onsubmit = function (event) {
    ...
    //nhanVien = {maNhanVien:1,tenNhanVien:'Phước',...}
    // nhanVien['maNhanVien']
    let contentHTML = '';
